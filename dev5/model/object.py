...
class Object:
    def __init__(self):
        ...
        self.cursor.execute('''CREATE TABLE IF NOT EXISTS TBL_OBJECT_PROTO (
                               OBJUUID VARCHAR(36) NOT NULL,
                               NAME VARCHAR(32) NOT NULL,
                               PRIMARY KEY (OBJUUID))''')
        
        self.cursor.execute('''CREATE TABLE IF NOT EXISTS TBL_OBJECT_XREF (
                               OBJUUID VARCHAR(36) REFERENCES TBL_OBJECT_PROTO(OBJUUID) NOT NULL,
                               CREATES VARCHAR(36) REFERENCES TBL_OBJECT_PROTO(OBJUUID) NOT NULL,
                               PRIMARY KEY (OBJUUID, CREATES))''')
